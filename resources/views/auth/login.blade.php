...
<form method="POST" action="{{ route('login') }}">
    ...
    <div class="page page_simple">
        <div class="entry">
            <div class="entry__wrapper"><a class="entry__logo" href="#"><img class="some-icon" src="img/logo-dark.png"
                        alt="Core"><img class="some-icon-dark" src="img/logo-light.png" alt="Core"></a>
                <div class="h2 entry__title">Sign in</div>
                <div class="entry__top" style="display: block">
                    <div class="entry__text">Sign up with Open account</div>
                    <div class="entry__btns"> 
                        <button class="button-stroke entry__button">
                            <a href="{{ URL::to("googlelogin") }}"><img src="{{asset('img/content/google.svg')}}"  
                                 alt="Google">Google</button></a>
                    </div>
                ...
                <div class="entry__fieldset">
                    <div class="field field_icon">
                        <div class="field__wrap">
                            <input class="field__input" class="form-control @error('email') is-invalid @enderror"
                    ...
                    <div class="field field_icon">
                        <div class="field__wrap">
                            <input class="field__input" type="password"  class="form-control @error('password') is-invalid @enderror" name="password"  placeholder="Password">
                            @error('password')
                            <span class="invalid-feedback" role="alert" style="display: block">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <input type="submit" value="Sign in" class="button entry__button" >
                </div>
                <div class="entry__note" style="display: none">This site is protected by reCAPTCHA and the Google Privacy Policy.</div>
                <div class="entry__info">Don’t have an account? <a href="">Sign up</a></div>
            </div>
        </div>
    </div>
</form>
