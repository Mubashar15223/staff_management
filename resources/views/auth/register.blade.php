...
<head>
    ...
    <link rel="manifest" href="{{asset('img/site.html')}}">
    <link rel="mask-icon" href="{{asset('img/safari-pinned-tab.svg')}}" color="#5bbad5">
    <link rel="preconnect" href="https://fonts.googleapis.com/">
    <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin>
    <link href="{{asset('css/fonts.googleapis.min.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-toast-plugin/1.3.2/jquery.toast.css" integrity="sha512-8D+M+7Y6jVsEa7RD6Kv/Z7EImSpNpQllgaEIQAtqHcI0H6F4iZknRj0Nx1DCdB+TwBaS+702BGWYC0Ze2hpExQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.2/css/fontawesome.min.css" integrity="sha384-BY+fdrpOd3gfeRvTSMT+VUZmA728cfF9Z2G42xpaRkUGu2i3DyzpTURDo5A6CaLK" crossorigin="anonymous">    <link rel="stylesheet" media="all" href="{{asset('css/app.min.css')}}">
    {{-- end outer --}}
    <!-- Fonts -->
...
<div class="page page_simple">
    <div class="login">
      ...
      <div class="login__col">
        <div class="login__head"><a class="login__logo" href="#"><img class="some-icon" src="img/logo-dark.png" alt="Core"><img class="some-icon-dark" src="img/logo-light.png" alt="Core"></a>
          <div class="login__info">Already a member? <a href="{{route('login')}}">Sign in</a></div>
        </div>
        <div class="login__wrapper">
          ...
          <div class="login__entry">
            <div class="login__top">
              ...
              <div class="login__btns">
                <button style="flex:unset;width:100%" class="button-stroke login__button"><img src="img/content/google.svg" alt="Google">Google</button>
            ...
            <div class="login__fieldset">
              <div class="field field_icon">
                <div class="field__wrap">
                  <input class="field__input user_email" type="email" name="email"  placeholder="Your email">
              ...
              <button class="button login__button continue_otp_btn">Continue</button>
          ...
          <div class="login__fieldset register_section" style="display: none">
            <div style="text-align: center;" class="login__text"></div>
            <div class="field field_icon" style="display: none">
              <div class="field__wrap">
                <input class="field__input reg_email" value="" type="hidden" name="email" >
            ...
            <div class="field field_icon">
              <div class="field__wrap">
                <input class="field__input user_password" type="password" name="password"  placeholder="Your Password">
            ...
            <div class="field field_icon">
              <div class="field__wrap">
                <input class="field__input user_confirm" type="password" name="confirm_password"  placeholder="Confirm Password">
                <div class="field__icon">
                  <svg class="icon icon-mail">
                    <use xlink:href="#icon-mail"></use>
                  </svg>
            ...
            <button class="button login__button setup_password_btn">Continue</button>
            <div class="login__note">This site is protected by reCAPTCHA and the Google Privacy Policy.</div>
          </div>
          <div class="login__code">
            ...
            <div class="login__error">The code you entered is incorrect.</div>
            <a class="button login__button verify_code_button" href="javascript:void(0)">
  ...
  <script src="{{asset('js/lib/jquery.richtext.min.js')}}"></script>
  <script src="{{asset('js/lib/jquery.fancybox.min.js')}}"></script>
  <script src="{{asset('js/lib/jQuery.tagify.min.js')}}"></script>
...
$(document).ready(function() {
   ...
   $(".login__title").text('Sign Up');
   $("body").on('click', '.setup_password_btn', function() {
         ...
         if(password !== confirm_password){
             showErrorMessage('The password is mismatch');
             return false
         }
   ...
   $("body").on('click', '.continue_otp_btn', function() {
       ...
       $.ajax({
           type: "POST",
           url: appUrl+"/user/sendVerificationEmail", // Use appUrl variable here
           data: { 
               email: email,
           ...
           success: function(response) {
               ...
               if(response.status){
                ...
                showSuccessMessage('The verification code has sent in email, please check your email');
   ...
   $("body").on('click', '.verify_code_button', function() {
...
function savePassword(email, password){
  ...
  $.ajax({
           type: "POST",
           url: appUrl+"/user/savePassword", // Use appUrl variable here
           data: { 
               email: email,
               password:password,
               _token: csrfToken // Include CSRF token in the data
...
function verifyCode(){
  ...
  let code1 = $("input[name=code1]").val();
  let code2 = $("input[name=code2]").val();
  let code3 = $("input[name=code3]").val();
  let code4 = $("input[name=code4]").val();
  // make one code
  ...
  if(code == 4312){
    $(".login__title").text('Set your password');
    $(".login__entry").hide();
    $(".login__code").hide();
    $(".register_section").show();
    showSuccessMessage('Verification Code Verified');
  }else {
    showErrorMessage('Verification Code Is Incorrect');
  }
