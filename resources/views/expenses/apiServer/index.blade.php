        ...
        <div class="transactions__wrapper">
          <div class="transactions__table">
            <div class="transactions__row">
                <div class="transactions__col">Name</div>
            ...
            @foreach ($apiServers as $item)
                
            
            <div class="transactions__row">
                <div class="transactions__col">
                    <div class="transactions__label">Name</div><span style="margin-right:10px">{{$item->name}}</span>
                </div>
              <div class="transactions__col">
              ...
              <div class="transactions__col">
                ...
                <div class="transactions__amount">{{$item->website}}</div>
              </div>
              <div class="transactions__col">
              ...
              <form action="{{ route('apiServer.destroy', $item->id) }}" method="POST" id="delete_form_{{$item->id}}">
                @csrf
                @method('DELETE')
              </form>
            </div>
...
<script>
    function edit(id)
    {
        var editRoute  = "{{route('apiServer.edit',  'id' )}}"
