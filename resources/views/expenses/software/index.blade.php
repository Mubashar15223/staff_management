          ...
          <div class="transactions__table">
            ...
            <div class="transactions__row">
              ...
              <div class="transactions__col">
                ...
                <div class="status-green-dark transactions__status">{{$item->companyName}}</div>
              </div>
              <div class="transactions__col">
              ...
              <form action="{{ route('software.destroy', $item->id) }}" method="POST" id="delete_form_{{$item->id}}">
                @csrf
                @method('DELETE')
              </form>
            </div>
...
@endsection
  ...
  <script>
      function edit(id)
      {
          var editRoute  = "{{route('software.edit',  'id' )}}"
