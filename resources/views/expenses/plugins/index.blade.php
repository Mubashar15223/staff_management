              ...
              <div class="income__line">
                <div class="income__details">
                  <div class="income__label">Total Subscribe
                    <div class="tooltip" title="Total amount of those plugins which need to be subscribe yearly.">
                      <svg class="icon icon-info">
                        <use xlink:href="#icon-info"></use>
                      </svg>
                    </div>
              ...
              <div class="income__line">
                <div class="income__details">
                  <div class="income__label">Cost / Web
                    <div class="tooltip" title="Many plugins can be used multiple times.">
                      <svg class="icon icon-info">
                        <use xlink:href="#icon-info"></use>
                      </svg>
                    </div>
        ...
        <div class="transactions__wrapper">
          <div class="transactions__table">
            ...
            <div class="transactions__row">
              ...
              <div class="transactions__col">
                <div class="transactions__product">{{$item->pluginName}}</div>
              ...
              <form action="{{ route('plugin.destroy', $item->id) }}" method="POST" id="delete_form_{{$item->id}}">
                @csrf
                @method('DELETE')
              </form>
            </div>
...
@endsection
  ...
  <script>
      function edit(id)
      {
          var editRoute  = "{{route('plugin.edit',  'id' )}}"
