...
@extends('layouts.app')
@section('content')
<form method="POST" action="{{ route('plugin.store') }}">
  @csrf
                  ...
                  <div class="field">
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <input class="field__input" type="text" name="platformName" required>
                        </div>
                      </div>
                      <div class="field">
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <input class="field__input" type="text" name="pluginName" required>
                        </div>
                      </div>
                      <div class="field">
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <div class="field__wrap">
                            <input placeholder="1-60" class="field__input" type="text" name="supportPeriod" required>
                          </div>
                        </div>
                      </div>
                      <div class="field">
