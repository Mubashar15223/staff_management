                  ...
                  <div class="field">
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <input class="field__input" type="text" name="website" required>
                        </div>
                      </div>
                      <div class="field">
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <input class="field__input" type="text" name="storage" required>
                        </div>
                      </div>
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <input class="field__input" type="date" name="purchaseDate" required>
                        </div>
                      </div>
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <div class="field__wrap">
                            <input placeholder="1-60" class="field__input" type="number" name="months" min="1" max="60" required>
                          </div>
                        </div>
                      </div>
                      <div class="field">
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <div class="field__wrap">
                            <input class="field__input" type="number" name="renewalAmount">
                          </div>
                        </div>
                      </div>
                      <div class="field">
                    ...
                    <div class="settings__row">
                      <div class="field">
                        ...
                        <div class="field__wrap">
                          <div class="field__wrap">
                            <input class="field__input" type="text" name="location">
                          </div>
                        </div>
                      </div>
                    </div>
